...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        <a href="/majors" class="text-xs uppercase tracking-[0.15em] text-slate-400 hover:text-[#A16207]">&larr; Buku
            Induk</a>
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div>
            <label for="name"
                class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Nama Jurusan
                Lengkap</label>
        ...
        <div class="flex justify-end gap-4 border-t border-[#EFEDE6] pt-6">
            <a href="/majors" class="px-4 py-2.5 text-sm font-medium text-slate-500 hover:text-[#16213A]">Batal</a>
            <button type="submit"
